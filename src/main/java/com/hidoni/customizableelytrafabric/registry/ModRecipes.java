...
public class ModRecipes {
    ...
    public static SpecialRecipeSerializer<SplitToWingRecipe> ELYTRA_TO_VANILLA_RECIPE = Registry.register(Registry.RECIPE_SERIALIZER, new Identifier(CustomizableElytra.MOD_ID, "elytra_wing_split_recipe"), new SpecialRecipeSerializer<>(SplitToWingRecipe::new));
    public static SpecialRecipeSerializer<ElytraToVanillaRecipe> SPLIT_TO_WING_RECIPE = Registry.register(Registry.RECIPE_SERIALIZER, new Identifier(CustomizableElytra.MOD_ID, "elytra_to_vanilla_recipe"), new SpecialRecipeSerializer<>(ElytraToVanillaRecipe::new));
